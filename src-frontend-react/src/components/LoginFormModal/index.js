              ...
              <Col>
                <Tab.Content>
                  <Tab.Pane eventKey="login">
                    ...
                    <Form className='d-grid gap-3 w-100 mb-3' noValidate onSubmit={handleLogin}>
                      ...
                      <Container>
                        <Row>
                          ...
                          <Col className='pe-0'>
                            <Button className='w-100' onClick={() => glogin()}><i class="bi bi-google"></i></Button>
                          </Col>
                        </Row>
                      </Container>
                    </Form>
                    <Stack direction='horizontal' className='justify-content-center mb-3'>
                      <Button variant='link' onClick={() => setTabKey('register')}>Register</Button>
                      <div className="vr" />
                      <Button variant='link' onClick={() => toast("Please contact an administrator to reset your password.")}>Forgot Password</Button>
                    </Stack>
                  </Tab.Pane>
                  <Tab.Pane eventKey="register">
                    <RegistrationForm />
                    <div className='d-flex w-100 justify-content-center'>
                      <Button className='mx-auto' variant='link' onClick={() => setTabKey('login')}>Login</Button>
                    </div>
                  </Tab.Pane>
